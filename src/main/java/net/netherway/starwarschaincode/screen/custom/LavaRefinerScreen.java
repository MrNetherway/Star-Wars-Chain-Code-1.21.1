...
public class LavaRefinerScreen extends AbstractContainerScreen<LavaRefinerMenu> {
    private static final ResourceLocation GUI_TEXTURE =
            ResourceLocation.fromNamespaceAndPath(StarWarsChainCode.MOD_ID, "textures/gui/lava_refiner/lava_refiner_gui.png");
    ...
    private static final ResourceLocation BAR_TEXTURE =
            ResourceLocation.fromNamespaceAndPath(StarWarsChainCode.MOD_ID, "textures/gui/bar_progress.png");

    public LavaRefinerScreen(AbstractContainerMenu menu, Inventory playerInventory, Component title) {
        super((LavaRefinerMenu) menu, playerInventory, title);
    }
