...
import net.netherway.starwarschaincode.entity.ai.GuardPositionGoal;
...
public class StormtrooperCommanderEntity extends Monster implements RangedAttackMob, FactionMember {

    public StormtrooperCommanderEntity(EntityType<? extends Monster> type, Level level) {
        super(type, level);
    ...
    private GuardPositionGoal guardPositionGoal;

    public void setGuardPosition(BlockPos pos, int radius) {
        if (this.guardPositionGoal != null) {
            this.guardPositionGoal.setGuardPosition(pos, radius);
        }
    }
    ...
    protected void registerGoals() {
        this.guardPositionGoal = new GuardPositionGoal(this, 1.0D);
        ...
        this.goalSelector.addGoal(2, guardPositionGoal);
